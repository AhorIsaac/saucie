...
function checkIfEmpty($inputName)
{
    if (empty($inputName)) {
        session_start();
        $_SESSION['staff_registration_error'] =
            '<div class="alert alert-danger text-center alert-dismissible fade show " style="font-family: monospace; font-size: 13px; display: inline-block;">
...
{
    $staff = new Staff();
    $accountFound = $staff->validStaffEmail($email);
    if ($accountFound == TRUE) {
        session_start();
        $_SESSION['staff_registration_error'] =
            '<div class="alert alert-warning text-center alert-dismissible fade show " style="font-family: monospace;  font-size: 13px; display: inline-block;">
                <button class="close" data-dismiss="alert"> <span aria-hidden="true">&times;</span> </button>
                <h6 class="alert-heading">  Account Already Exist! </h6>
                <p class=""> This staff has already registered with Saucie <br />
...
<body>
    <div class="container">
        ...
        <div class="text-center">
            <?php if (isset($_SESSION['staff_registration_error'])) {
                echo $_SESSION['staff_registration_error'];
                unset($_SESSION['staff_registration_error']);
            } ?>
        </div>
        ...
        <div class="row justify-content-around">
            ...
            <div class="col-sm-6 p-3 m-3 shadow-lg" id="main">
                <h4 class="course-heading m-5 text-dark text-left">
                    <i class="fa fa-user-circle fa-1x"></i> Staff Registration Page
                </h4>
