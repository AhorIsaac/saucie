...
if (isset($_SESSION["staff_id"])) {
    ...
    $new_staff = new Staff();
    $getData = $new_staff->selectOneStaffInfo($staff_id);
}
...
if (isset($_POST["update"])) {
    ...
    $update_staff = new Staff();
    $update_staff_information = $update_staff->updateStaffInfo($fields, $id);

    if ($update_staff_information === TRUE) {
        $updated_details = $update_staff->getUpdatedDetails($email);
    }
}
...
<body class="bg-light">
    <div class="container pt-3 mt-3">
        ...
        <h4 class="text-center" id="up"> Staff Update Information Page </h4>
        <div class="jumbotron bg-light  shadow-lg" id="staff_frame">
            <h3 class="text-center"> <?php $im = $getData["profileimage"]; ?>
                <img src="../public/storage/staff_profileimage/<?php echo $im ?>" alt="pic" id="proim" />
            ...
            <form method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-7 input-group">
                        ...
                        <input type="text" class="form-control" placeholder="Salary" name="salary" value="<?php if( $getData["SALARY"] && $getData["SALARY"] !== null) { echo $getData["SALARY"]; } else { echo "NIL"; } ?>" disabled />
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class='col-sm-7'>
                        <input type="file" name="profileimage" class="form-control" placeholder="Select Image" accept="image/*" />
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class='col-sm-7'>
                        ...
                        <a href="staff-homepage.php" class="btn btn-info btn-sm text-dark font-weight-bold">
