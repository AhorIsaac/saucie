...
if (isset($_SESSION["cus_id"])) {
    ...
    $customer = new Food();
    $userDetails = $customer->lunchCartUserDetails($user_id);

    $_SESSION["userDetails"] = $userDetails;

    if ($userDetails == 0) {
        session_start();
        $_SESSION["empty_lunch_cart"] =
            '<div class="alert alert-info alert-dismissible fade show text-center" style="font-family: monospace; font-size: 14px; display: inline-block;">
            <button role="button" class="close" data-dismiss="alert"> <span aria-hidden="true">&times;</span> </button>
            <h5 class="alert-heading"> Empty <i class="fa fa-cart-plus fa-1x"></i> </h5>
            <p> Your cart is empty </p>
        </div>';
        header("location: food-lunch.php");
        exit();
    }
...
<body>
    <div class="container">
        ...
        <div class="text-center">
            ...
            if (isset($_SESSION["delete_lunch_success"])) {
                echo $_SESSION["delete_lunch_success"];
                unset($_SESSION["delete_lunch_success"]);
            }
            ?>
        </div>

        <!-- ALL ABOUT LUNCH FRAME -->
        <form action="checkout-lunch-cart.php" method="POST">
            <div class="mb-4">
                ...
                <table class="table-hover table-striped table-bordered shadow-lg" style="margin: auto">
                    <thead class="text-center">
                        <tr>
                            ...
                            <th class="p-3 m-2">
                                <a href="../controllers/delete-all-from-lunch-cart.php" class="btn btn-danger btn-md" onclick="return confirm('Do you wish to clear your cart?'); ">
                    ...
                    <tbody class="text-center">
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    <p class="" style="font-size: 18px;">
                                        <a href="../controllers/delete-from-lunch-cart.php?food_id=<?php echo $details["foodId"]; ?>" class="btn btn-outline-danger btn-sm text-center" onclick="return confirm('Are you sure you want to remove this item?'); ">
                    ...
                    <tfoot class="text-center">
                        <tr>
                            <td colspan="2">
                                <a href="food-lunch.php" class="btn btn-outline-success">
                            ...
                            <td colspan="">
                                <button type="submit" href="checkout-lunch-cart.php" class="btn btn-outline-info" onclick="return confirm('Do you wish to make your payment?'); " name="checkout_submit">
