...
if (isset($_SESSION["cus_id"])) {
    ...
    $customer = new Food();
    $userDetails = $customer->breakfastCartUserDetails($user_id);

    $_SESSION["userDetails"] = $userDetails;

    if ($userDetails == 0) {
        session_start();
        $_SESSION["empty_breakfast_cart"] =
        ...
        header("location: food-breakfast.php");
        exit();
    }
...
<body>
    <div class="container">
        ...
        <div class="text-center">
            ...
            if (isset($_SESSION["delete_breakfast_success"])) {
                echo $_SESSION["delete_breakfast_success"];
        ...
        <form action="checkout-breakfast-cart.php" method="POST">
            <div class="mb-4">
                ...
                <table class="table-hover table-striped table-bordered shadow-lg" style="margin: auto;">
                    <thead class="text-center">
                        <tr>
                            ...
                            <th class="p-3 m-2">
                                <a href="../controllers/delete-all-from-breakfast-cart.php" class="btn btn-danger btn-md" onclick="return confirm('Do you want to clear your cart?'); ">
                    ...
                    <tbody class="text-center">
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    <p class="" style="font-size: 18px;">
                                        <a href="../controllers/delete-from-breakfast-cart.php?food_id=<?php echo $details["foodId"]; ?>" class="btn btn-outline-danger btn-sm text-center" onclick="return confirm('Are you sure you want to remove this item?'); ">
                    ...
                    <tfoot class="text-center">
                        <tr>
                            <td colspan="2">
                                <a href="food-breakfast.php" class="btn btn-outline-success">
                            ...
                            <td colspan="">
                                <button type="submit" href="checkout-breakfast-cart.php" class="btn btn-outline-info" onclick="return confirm('Make your payment?'); " name="checkout_submit">
