...
if ($activeCus === TRUE) {
    ...
    header("location: food-drinks-view.php");
    exit();
}
...
<body>
    <div class="container">
        ...
        <div class="text-center bg-white shadow jumbotron mb-lg-5 mt-lg-5 mt-md-5 mb-md-5" id="print_button_frame">
            <a href="../controllers/clear-drinks-cart.php" class="btn btn-outline-success btn-md" id="process_button" <?php if (isset($_SESSION["process_success"])) { ?> style="display: none;" <?php } ?>>
            ...
            ?>
                    ...
                    <a href="../controllers/finalize-drinks-order.php" class="btn btn-outline-success btn-md m-2" id="print_not_button">
                        Don't Print Receipt
                    </a>

                    <a href="../controllers/finalize-drinks-order.php" class="btn btn-outline-primary btn-md  m-2" id="print_not_button">
