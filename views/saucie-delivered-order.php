...
if (isset($_POST["submit_button"])) {
    ...
    $order = new Order();
    $orderInfo = $order->selectParticularDeliveredOrderBasedOnReferenceNumber($reference_number, $order_table);
}
...
<body class="bg-light">
    <div class="container-fluid">
        ...
        <div class='jumbotron bg-white shadow mt-md-4 mt-lg-4'>
            ...
            <div class="jumbotron justify-content-center text-center bg-white  m-auto">
                <div class="">
                    <div class="container row justify-content-around">
                        ...
                        ?>
                            <div class="col-md-3 col-lg-3">
                                <h4 class="course-heading text-info font-weight-bold text-center" style="font-family: monospace">
                                    Delivered by
                                </h4>
                                <img src="../public/storage/staff_profileimage/<?php echo $info["order_staff_image"]; ?>" id="staff_img" class="d-inline shadow mb-2" />
                                <h5 class="course-heading text-info font-weight-bold text-center" style="font-family: monospace">
                                    Staff <?php echo $info["order_staff_name"]; ?>
                                </h5>
                            </div>
                        <?php
                            break;
            ...
            <div class="text-center m-2">
                <a href="saucie-all-delivered-order.php" class="btn btn-outline-info m-2" id="ord_btn">
                    Return to Delivered Order Homepage
                </a>
                <a href="#" class="btn btn-outline-success m-2 disabled" id="ord_btn">
