...
<head>
    ...
    <style>
        ...
        #dinner_frame input[type="number"] {
            width: 80px;
            color: black;
            font-weight: bold;
        }
...
<body>
    <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarMenu">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item dropdown font-weight-bold">
                        <a class="nav-link dropdown-toggle text-center" href="#" id="foodCategory" data-toggle="dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="foodCategory" id="category">
                            <a class="dropdown-item" href="food-dinner-view.php">
                                View Items / Checkout
                            </a>
        ...
        <div class="text-center">
            <?php
            if (isset($_SESSION["empty_dinner_cart"])) {
                echo $_SESSION["empty_dinner_cart"];
                unset($_SESSION["empty_dinner_cart"]);
            }

            if (isset($_SESSION["delete_all_dinner_success"])) {
                echo  $_SESSION["delete_all_dinner_success"];
                unset($_SESSION["delete_all_dinner_success"]);
            }

            if (isset($_SESSION["dinner_added_to_cart"])) {
                echo $_SESSION["dinner_added_to_cart"];
                unset($_SESSION["dinner_added_to_cart"]);
            }

            if (isset($_SESSION["dinner_already_in_cart"])) {
                echo $_SESSION["dinner_already_in_cart"];
                unset($_SESSION["dinner_already_in_cart"]);
            }
            ?>
        </div>
        ...
        <div class="mb-4">
            <h3 class="text-center" style="font-family: arial;"> Saucie Dinner Homepage </h3>
            <div class="row justify-content-around">
                <?php
                $dinner = new Food();
                $dinnermeals = $dinner->selectAllDinnerMeals(); ?>

                <?php foreach ($dinnermeals as $dinner) {  ?>

                    <div class="col-md-3 col-lg-3 col-sm-5 text-center ml-2 mr-2 mt-3 mb-3 shadow bg-white" style="min-width: 300px;" id="dinner_frame">
                        <img class="card-img-top" src="../public/storage/uploaded_food/<?php echo $dinner["image"]; ?>" alt="" id="food_img" />
                        <div class="text-center" style="font-family: monospace;">
                            <h4 class="" style="font-family: monospace" ;>
                                <span style="font-family: monospace; font-weight: bold"> </span> <?php echo $dinner["name"]; ?>
                            </h4>
                            <p class="" style="font-size: 18px;"> <span style="font-family: monospace; font-weight: bold"> Price Tag </span> :
                                <span> &#8358; </span> <?php echo $dinner["price_tag"]; ?>
                            </p>
                            <form class="form text-center" method="POST" action="../controllers/add-to-dinner-cart.php">
                                <input type="hidden" name="food_id" value="<?php echo $dinner["id"]; ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <a href="food-view-single-food-data.php" class="btn btn-outline-success btn-md">
